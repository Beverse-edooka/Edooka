...
export default function QuizPage() {
  ...
  if (bootError === "slug") {
    return (
      <section className="quiz-shell rounded-2xl border border-border-default bg-white p-8 text-center shadow-sm">
  ...
  if (!attempt) {
    return (
      <section className="quiz-shell rounded-2xl border border-border-default bg-white p-8 text-center">
  ...
  if (quizLoadError) {
    ...
    return (
      <section className="quiz-shell space-y-4 rounded-2xl border border-border-default bg-white p-8 text-center shadow-sm">
  ...
  if (!quizProgram || questions.length === 0 || !current) {
    return (
      <section className="quiz-shell rounded-2xl border border-border-default bg-white p-8 text-center space-y-4">
  ...
  return (
    <section className="quiz-shell flex flex-col gap-3 rounded-2xl border border-border-default bg-white p-5 shadow-[0_12px_28px_rgba(255,149,88,0.18)] sm:gap-4 sm:p-6">
